...
Route::get('/admin/e-i-q', 'EventsController@create')->name('create_e-i-q');//Todo: This route must not be accessible without successfulluly passing registration via Auth middleware
...
Route::post('/admin/events/store', 'EventsController@store')->name('store_events');//Todo: This route must not be accessible without successfulluly passing registration via Auth middleware
